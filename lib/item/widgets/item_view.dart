...
class ItemView {
  void show(BuildContext context, Item item, int quantity,
    ...
    Future<List<Supplement>> loadSupplements() async {
      try {
        supplements =
            await SupplementController().getSupplementsByItemId(item.id);
        return supplements;
      } catch (error) {
        print('Erreur lors du chargement des suppléments: $error');
        return [];
      }
    }
                                  ...
                                  onPressed: () {
                                    ...
                                    for (var id in selectedSupplementIds) {
                                      Supplement selectedSupplement =
                                          supplements.firstWhere((supplement) =>
                                              supplement.id == id);
                                      selectedSupplements
