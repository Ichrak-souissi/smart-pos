...
//  Enpoints pour la gestion des payements
  ...
  static String updateTableUrl(String id) =>
  ...
  static String getItemsByCategoryIdUrl(String id) =>
      '$baseUrl$itemEndpoint/category/$id';
  ...
  static String getIngredientByItemIdUrl(String id) =>
      '$baseUrl$ingredientEndpoint/item/$id';

  // URLs pour les endpoints liés aux ingrédient
  static String getUpdateIngredientUrl(String string) =>
      '$baseUrl$updateIngredientEndpoint';

//Urls pour les endpoints liés au suppléments
  static String getSupplementByItemIdUrl(String id) =>
      '$baseUrl$supplementEndpoint/item/$id';

  static String getUpdateSupplementUrl(String string) =>
      '$baseUrl$updateSupplementEndpoint';
...
//Urls pour les endpoints des order
  ...
  static String getOrdersByTableIdUrl(String tableId) =>
